...
hashpw = &Comeonin.Bcrypt.hashpwsalt/1

Hexpm.Repo.transaction(fn ->
  eric = insert(:user, username: "eric", emails: [build(:email, email: "eric@example.com")], password: hashpw.("ericric"))
  jose = insert(:user, username: "jose", emails: [build(:email, email: "jose@example.com")], password: hashpw.("josejose"))
  joe = insert(:user, username: "joe", emails: [build(:email, email: "joe@example.com")], password: hashpw.("joejoejoe"))
  justin = insert(:user, username: "justin", emails: [build(:email, email: "justin@example.com")], password: hashpw.("justinjustin"))
